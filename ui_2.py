...
class IntroPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        if self.logo_label is None:
            self.logo_text = tk.Label(self.logo_frame, text="DUROBOT", font=("Arial", 32, "bold"), bg="#f5f7fa", fg="#2c5aa0")
    ...
    def load_company_logo(self):
        ...
        try:
            ...
            for logo_path in logo_paths:
                full_path = os.path.join(base_dir, logo_path)
...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.title_label = tk.Label(self.title_frame, text="TES DISLEKSIA", font=("Arial", 30, "bold"), bg="#f5f7fa", fg="#2c5aa0")
...
class ResultPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.lbl_verdict = tk.Label(self.center_frame, text="...", font=("Arial", 35, "bold"), bg="#f5f7fa", fg="#333333")
